...
public class CompanyMController extends DialogPageController {
    ...
    protected synchronized void initDialogItems() {
        if (dialogItems.size() == 0) {
            DialogItem title = new DialogItem("name", "公司名");
            ...
            DialogItem phone = new DialogItem("phone", "手机", DialogItemEnum.TEXT.getStr());

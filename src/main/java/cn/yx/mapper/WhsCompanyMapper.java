...
public interface WhsCompanyMapper {
    ...
    @Insert({ "insert into whs_company (id, name, ", "type, image, principal, ", "phone, tele, mail, ",
            "status, address, ", "create_time, url)", "values (#{id,jdbcType=INTEGER}, #{name,jdbcType=VARCHAR}, ",
            ...
            "#{createTime,jdbcType=BIGINT}, #{url,jdbcType=LONGVARCHAR})" })
     ...
     * @mbg.generated  Mon Aug 14 20:03:18 CST 2017
     */
    @Select({ "select", "id, name, type, image, principal, phone, tele, mail, status, address, create_time, ", "url",
    ...
    @Update({ "update whs_company", "set name = #{name,jdbcType=VARCHAR},", "type = #{type,jdbcType=TINYINT},",
            ...
            "address = #{address,jdbcType=VARCHAR},", "create_time = #{createTime,jdbcType=BIGINT},",
    ...
    @Select("SELECT max(id) + 1 FROM whs_company")
    Integer getLastId();
}
...
public interface WhsActivitiesMapper {
     ...
     * This method corresponds to the database table whs_activities
     *
     ...
     */
    @Insert({
        "insert into whs_activities (id, title, ",
    ...
    List<WhsActivities> selectAllWithoutStatus();

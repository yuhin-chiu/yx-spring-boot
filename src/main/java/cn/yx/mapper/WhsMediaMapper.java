...
public interface WhsMediaMapper {
     ...
     * @mbg.generated  Sun Jul 23 15:42:13 CST 2017
     */
    @Insert({ "insert into whs_media (id, name, ", "type, image, principal, ", "phone, tele, mail, ", "address, url)",
            ...
            "#{address,jdbcType=VARCHAR}, #{url,jdbcType=LONGVARCHAR})" })
     ...
     * @mbg.generated  Sun Jul 23 15:42:13 CST 2017
     */
    @Select({ "select", "id, name, type, image, principal, phone, tele, mail, address, url", "from whs_media",

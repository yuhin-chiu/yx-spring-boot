...
public interface WhsDownloadsMapper {
    ...
    @Insert({ "insert into whs_downloads (id, browses, ", "title, abstr, status, ", "create_time, annex, ",
            "annex_name, downs, ", "author, content)", "values (#{id,jdbcType=INTEGER}, #{browses,jdbcType=BIGINT}, ",
     ...
     * @mbg.generated  Wed Aug 09 09:52:41 CST 2017
     */
    @Select({ "select", "id, browses, title, abstr, status, create_time, annex, annex_name, downs, author, ", "content",
    ...
    @Update({ "update whs_downloads", "set browses = #{browses,jdbcType=BIGINT},", "title = #{title,jdbcType=VARCHAR},",
            ...
            "author = #{author,jdbcType=VARCHAR},", "content = #{content,jdbcType=LONGVARCHAR}",
